...
bool SelfExplain(const vector<Symbols>& symbols,vector<LanguageTranslations>& languages)
{
	...
	Wll0Intepreter1 intepreter(symbols, output_symbols, languages);
	bool retval = intepreter.IntepretWll0();
	cout<<output_symbols;
	return retval;
}
#else
...
{
	vector<Symbols> output_symbols;
	Wll0Intepreter0 intepreter(symbols, output_symbols, languages);
	bool retval = intepreter.IntepretWll0();
	cout<<output_symbols;
	return retval;
}
