...
Wll0Loader::Wll0Loader()
{
	this->input_pos = 0;
}

Wll0Loader::Wll0Loader(const vector<Symbols>& input_symbols)
{
...
void Wll0Loader::SetInputSymbols(const char* text)
{
...
bool Wll0Loader::LoadWll0(vector<LanguageTranslations>& translations)
{
...
bool Wll0Loader::LoadTranslation(LanguageTranslations& translation)
{
	//
...
bool Wll0Loader::LoadSourceRule(LanguageRules& source_rule)
{
...
bool Wll0Loader::LoadDestinationRule(LanguageRules& destination_rule)
{
...
bool Wll0Loader::LoadRule(LanguageRules& rule)
{
...
bool Wll0Loader::LoadRootSymbol(Symbols& root_symbol)
{
	return
		this->LoadVariable(root_symbol);
}

bool Wll0Loader::LoadExpression(LanguageExpressions& expression)
{
...
bool Wll0Loader::LoadSymbol(LanguageExpressions& symbol)
{
	//
...
bool Wll0Loader::LoadVariable(Symbols& variable)
{
	//
...
bool Wll0Loader::LoadConstant(LanguageExpressions& constant)
{
...
bool Wll0Loader::LoadRemark(Symbols& remark)
{
...
bool Wll0Loader::LoadIdent(string& ident)
{
...
bool Wll0Loader::LoadString(LanguageExpressions& str)
{
	//<string>-->""==><string>-->"";
...
bool Wll0Loader::LoadOriginalString(LanguageExpressions& str)
{
	//<string>-->''==><string>-->'';
	//<string>--><character><string>==><string>--><character><string>;
...
bool Wll0Loader::EncountRemark(Symbols& remark)
{
...
bool Wll0Loader::ExpectRemark(Symbols& remark)
{
	//<remark>-->$*==><remark>-->$*;
...
bool Wll0Loader::ExpectLetter(char& c)
{
	//<letter>-->"a"==><letter>-->"a";
	//<letter>-->"b"==><letter>-->"b";
	//<letter>-->"c"==><letter>-->"c";
...
bool Wll0Loader::ExpectDigit(char& c)
{
	//<digit>-->"0"==><digit>-->"0";
	//<digit>-->"1"==><digit>-->"1";
	//<digit>-->"2"==><digit>-->"2";
...
bool Wll0Loader::ExpectCharacter(Symbols& symbol)
{
...
bool Wll0Loader::ExpectSpace(char& c)
{
	if(this->input_pos >= this->input_symbols.size()) return false;
...
bool Wll0Loader::Accept(const Symbols& symbol)
{
...
bool Wll0Loader::Accept(const LanguageExpressions& expression)
{
...
bool Wll0Loader::Encount(const Symbols& symbol)
{
	return this->GetSymbol()==symbol;
}

const Symbols& Wll0Loader::GetSymbol()
{
