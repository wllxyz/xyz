...
class CompactCommand : public WllCommand
{
public:
	CompactCommand(Symbols cmd, std::vector< std::vector<Symbols> >& parameter_fields, WllIntepreter* intepreter);
	virtual bool Intepret(std::vector<Symbols>& result);
};
...
class AppendCommand : public WllCommand
{
public:
	AppendCommand(Symbols cmd, std::vector< std::vector<Symbols> >& parameter_fields, WllIntepreter* intepreter);
	virtual bool Intepret(std::vector<Symbols>& result);
};
...
class SubStrCommand : public WllCommand
{
public:
