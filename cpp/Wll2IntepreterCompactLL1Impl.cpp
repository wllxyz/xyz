...
bool Wll2IntepreterCompactLL1Impl::IntepretExpression(std::vector<Symbols>& result)
{
...
bool Wll2IntepreterCompactLL1Impl::IntepretSExpression(std::vector<Symbols>& result)
{
	bool retval = true;
...
bool Wll2IntepreterCompactLL1Impl::Accept(const Symbols& symbol)
{
...
bool Wll2IntepreterCompactLL1Impl::Encount(const Symbols& symbol) const
{
	return this->GetSymbol()==symbol;
}

const Symbols& Wll2IntepreterCompactLL1Impl::GetSymbol() const
{
	return (this->input_pos >= this->input_symbols.size()) ? Symbols::END_SYMBOL : this->input_symbols[this->input_pos];
}

const Symbols& Wll2IntepreterCompactLL1Impl::AcceptSymbol()
{
	return (this->input_pos >= this->input_symbols.size()) ? Symbols::END_SYMBOL : this->input_symbols[this->input_pos++];
}

void Wll2IntepreterCompactLL1Impl::ShowErrorMessage()
{
